let guest_list = ["rimsha", "minahil", "marooj", "zoran"];
...
guest_list.forEach(new_guestlist => console.log(`Salam ${new_guestlist} would you like to come to the dinner at my house?`));
