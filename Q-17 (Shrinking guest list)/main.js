...
while (guest.length > 2) {
    ...
    console.log("sorry, ".concat(remove_guest, ", we cant invite you to the dinner."));
}
//   To print  a message  to  all the lucky  guest that are sytill invited 
console.log(" Invitation to the 2 lucky guests");
guest.forEach(function (lucky_guest) { return console.log("Luckily, ".concat(lucky_guest, " are still invited to the dinner")); });
