...
let visit_bucketlist = ["germany", "Turkiye", 'China', 'Canada', 'Japan'];
...
console.log(" Array copy in ALPHABETICAL ORDER of the array",[... visit_bucketlist].sort());
...
//  SHOWING MY ORIGINAL ORDER 
 ...
 console.log("REVERSE ORDER", [...visit_bucketlist].reverse());
...
//  here we are changeing the orginal array in alphabetical order and then again in reverse 
console.log( "Orginal in alphabetical order and then again in reverse", visit_bucketlist.sort().reverse());
