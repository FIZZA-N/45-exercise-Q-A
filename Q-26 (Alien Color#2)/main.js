...
if (alien_color === "blue") {
    //  code 
    console.log(" Player just earned 5 points for shooting an alien. because  alien is in ".concat(alien_color, " color "));
}
else {
...
if (alien_color === "white") {
    //  code 
    console.log(" Player just earned 0 points for shooting an alien. because  alien is in ".concat(alien_color, " color "));
}
else {
